                ...
                <div class="body-left flex-cols">
                    <div>
                        <div class="list-title-container" style="@isset($is_email) clear: both; display: table; @endisset">
                            <h3 class="seller-info__title ellipsis-2" title="{{ $list_value->title }}" style="@isset($is_email) margin-bottom: 0;margin-top: 0;float:left; @endisset"><a class="text-darker" href="{{ generateUrl($list_value->city['slug'], $list_value->slug) }}" target="_blank" style="@isset($is_email) color: #ec6d4b; @endisset">{{ $list_value->title }}</a></h3>
