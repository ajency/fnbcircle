...
class UpdatePepoBackupTable implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $parameters = [
            ...
            'attributes[userType]' => mergeFields($backup->userType,[],true),
            ...
            'attributes[jobRole]' => mergeFields($backup->jobRole,[],true),
            'attributes[jobCategory]' => mergeFields($backup->jobCategory,[],true),
            'attributes[jobArea]' => mergeFields($backup->jobArea,[],true),
