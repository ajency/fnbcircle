        ...
        <div style="margin-top: 2em;">
          <div style="margin-bottom: 0.8em;">
            <div style="float: left;text-align: left;color: rgba(123, 123, 123, 0.77);font-size: 0.9em;">
              ...
              <a href="{{ $confirmationLink }}" style="color: #ec6d4b;font-weight: 600;" target="_blank">Verify email</a> or copy and paste this link into your browser : {{ $confirmationLink }}<br><br>
              <br>
