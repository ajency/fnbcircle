...
@include('list-view.single-card.listing_card', array('exclude_enquiry' => 'true'))
            ...
            Disclaimer: FnB Circle is only a intermediary platform between the business owners and seekers and hence shall neither be responsible nor liable to mediate or resolve any disputes or disagreements between the business owners and seekers.<br>
            <div>
              Regards,<br>
              Team FnB Circle<br>
            </div>
