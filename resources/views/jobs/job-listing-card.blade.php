          ...
          <div class="body-left flex-cols">
              <div>
                  <div class="flex-row space-between">
                    <h3 class="seller-info__title ellipsis-2" title="Empire cold storage &amp; chicken products"><a href="{{ url('/job/'.$job->getJobSlug()) }}" class="text-darker" target="_blank">{{ $job->title }}</a></h3>
