	...
	// });
		...
		function validatePassword(password, confirm_password, parent_path, child_path) {
			...
			if(expression.test(password)) {
				...
				message = "Please enter a password of minimum 8 characters and has atleast 1 number.<br/><div>Note:<br/>Don’t use obvious passwords or easily guessable like your or your pet’s name.<br/>Also try and avoid using passwords you may have on a lot of other sites.</div>";
				status = false;
			}
