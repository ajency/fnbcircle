...
<div class="business-info tab-pane fade in active" id="company_details">
    ...
    <div class="m-t-40 c-gap">
        ...
        <input type="url" name="company_website" data-parsley-type="url" data-parsley-type-message="Please enter valid url"  class="form-control fnb-input" placeholder="http://" value="{{ $jobCompany['website'] }}">  
