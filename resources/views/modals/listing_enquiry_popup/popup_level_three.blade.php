        ...
        <div class="collapse formFields gap-separator row" id="personalDetailsCollapse" style="box-shadow: 0px 5px 10px #f0f0f0 inset, 0px -5px 10px #f0f0f0 inset;">
            <div class="col-sm-6">
                <div class="form-group m-b-0">
                    ...
                    <p><label>Name:</label> {{ !Auth::guest() ? Auth::user()->name : (isset($enquiry_data) && isset($enquiry_data['name']) ? $enquiry_data['name'] : '') }} </p>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group m-b-0">
                    ...
                    <p><label>Phone:</label> {{ !Auth::guest() ? (Auth::user()->getPrimaryContact()['contact_region'] . Auth::user()->getPrimaryContact()['contact']) : (isset($enquiry_data) && isset($enquiry_data['contact']) ? $enquiry_data['contact'] : '') }}</p>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group m-b-0">
                    ...
                    <p><label>Email: </label> {{ !Auth::guest() ? Auth::user()->email : (isset($enquiry_data) && isset($enquiry_data['email']) ? $enquiry_data['email'] : '') }}</p>
                </div>
            </div>
