            ...
            <div class="modal-header">
                ...
                <div class="mobile-back flex-row">
                    <div class="back">
                        ...
                        <button class="btn fnb-btn outline border-btn no-border category-back mobile-hide" type="button" id="back_to_categories"><i class="fa fa-arrow-left p-r-10" aria-hidden="true"></i> Back to Category</button>
                    </div>
                    <div class="level-two">
