          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_content">
                ...
                <input type="text" name="job_name" placeholder="Search by Job Name" id="job_name" class="form-control fnb-input pull-right customDtSrch jobsearchinput manage-search-box">
