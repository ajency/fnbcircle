                                        ...
                                        <div class="flex-row align-top">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="form-group p-t-5 m-b-0">
                                                    <button class="btn fnb-btn btn-link code-send primary-link p-l-0 no-outline" type="submit">Click to Upload Resume <i class="fa fa-circle-o-notch fa-spin fa-fw label-size hidden resume-loader"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="enquiry-form__body m-t-10">
                                            <div class="form-group">
                                                <label class="checkbox-inline send-alert">
                                                    ...
                                                    <input type="checkbox" @if($sendJobAlerts == null)checked @endif {{ ($sendJobAlerts) ? 'checked' : '' }}  name="send_job_alerts" class="fnb-checkbox custom-checkbox" value="1"><span class="default-size">Receive Alerts</span></span>
                                                </label>
                                            </div>
