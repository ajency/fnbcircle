<div class="main-category level-one-category m-l-30 m-r-30 m-b-30" id="level-one-category">
    ...
    <ul class="interested-options catOptions cat-select flex-row m-t-45">
       @foreach($parents as $category)
        ...
        <li class="catSelect-click">
            <input type="radio" class="radio parent-categories" name="parent-categories" data-name="{{$category->name}}" value="{{$category->id}}"/>
