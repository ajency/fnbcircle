     ...
     <!--        @if(hasAccess('edit_permission_element_cls',$data['reference'],'listing'))
            ...
            <div class="row">
                <div class="col-sm-8">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <ul class="nav-info__tabs flex-row">
                                                @if((isset($data['updates']) and !empty($data['updates'])) or hasAccess('edit_permission_element_cls',$data['reference'],'listing'))<li class="nav-section"><a class="active" href="#updates" title="Updates">Recent updates</a></li> @endif
                    ...
                    <!-- tabs structure ends -->
                    @if((isset($data['updates']) and !empty($data['updates'])) or hasAccess('edit_permission_element_cls',$data['reference'],'listing') )
                    <!-- updates section -->
